...
function ContactLinks(){
    return(
        <div className="contact flex">
            <img src="images/logo.png" alt="" className="logosmall"/>
            <h3>Inches N Feet</h3>
            <div className="socialmedia flex">
                <a href="https://www.linkedin.com/company/inchesnfeet">
                <svg version="1.1" className="icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
<path fill="#FFFFFF" d="M256,0C114.6,0,0,114.6,0,256s114.6,256,256,256s256-114.6,256-256S397.4,0,256,0z M181.6,387h-62.3V199.4
	...
	c-1.6,4-2.1,9.6-2.1,15.2V387h-62.3c0,0,0.8-170,0-187.6h62.3V226c8.3-12.8,23.1-31,56.2-31c41,0,71.8,26.8,71.8,84.4V387z"/>
                ...
                <a href="https://instagram.com/inches.n.feet?igshid=1vtuchucz15e5">
                <svg version="1.1" className="icon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewBox="0 0 512 512" enableBackground="new 0 0 512 512" >
